...
@implementation EQDatabaseManager

static EQDatabaseManager *sharedInstance = nil;
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"DeleteTheBoxes.sqlite"];
